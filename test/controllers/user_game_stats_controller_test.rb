...
class UserGameStatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create user_game_stat" do
    assert_difference('UserGameStat.count') do
      post user_game_stats_url, params: { user_game_stat: { highest_score: @user_game_stat.highest_score, total_games: @user_game_stat.total_games, total_score: @user_game_stat.total_score, user_id: @user_game_stat.user_id, wins: @user_game_stat.wins } }
    end
  ...
  test "should update user_game_stat" do
    patch user_game_stat_url(@user_game_stat), params: { user_game_stat: { highest_score: @user_game_stat.highest_score, total_games: @user_game_stat.total_games, total_score: @user_game_stat.total_score, user_id: @user_game_stat.user_id, wins: @user_game_stat.wins } }
